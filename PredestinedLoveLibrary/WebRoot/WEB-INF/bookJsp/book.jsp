	...
	<body>
		<div class="row">
		 ...
		 <div class="row col-md-3">
		 	<form action="<%=basePath %>/book/insertBook" method="post" enctype="multipart/form-data">
		 		<div class="form-group">
		 			<span>图书序号</span>
		 			<input class="form-control" type="text" name="bkID" placeholder="图书序号" />
		 		</div>
		 		<div class="form-group">
		 			<span>图书编号</span>
		 			<input class="form-control" type="text" name="bkCode" placeholder="图书编号"/>
		 		</div>
		 		<div class="form-group">
		 			<span>书名</span>
		 			<input class="form-control" type="text" name="bkName" placeholder="书名"/>
		 		</div>
		 		<div class="form-group">
		 			<span>作者</span>
		 			<input class="form-control" type="text" name="bkAuthor" placeholder="作者"/>
		 		</div>
		 		<div class="form-group">
		 			<span>出版社</span>
		 			<input class="form-control" type="text" name="bkPress" placeholder="出版社"/>
		 		</div>
		 		<div class="form-group">
		 			<span>出版日期</span>
		 		...
		 		<div class="form-group">
		 			<span>ISBN书号</span>
		 			<input class="form-control" type="text" name="bkISBN" placeholder="ISBN书号"/>
		 		</div>
		 		<div class="form-group">
		 			<span>分类号</span>
		 ...
		 <div class=" row col-md-3 ">
		 	<div class="form-group">
		 		...
		 		<div class="form-group">
		 			<span>页数</span>
		 			<input class="form-control" type="text" name="bkpages" placeholder="页数"/>
		 		</div>
		 		<div class="form-group">
		 			<span>价格</span>
		 			<input class="form-control" type="text" name="bkPrice" placeholder="价格"/>
		 		</div>
		 		<div class="form-group">
		 			<span>入馆日期</span>
		 		...
		 		<div class="form-group">
		 			<span>内容简介</span>
		 			<textarea class="form-control" name="bkBrief" placeholder="内容字数不要超100"></textarea>
		 		</div>
		 		<div class="form-group">
		 			<span>图书封面照片</span>
